...
func (in *CinderAPISpec) DeepCopyInto(out *CinderAPISpec) {
	*out = *in
	...
	if in.ExtraMounts != nil {
		...
		*out = make([]CinderVolMounts, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CinderExtraVolMounts) DeepCopyInto(out *CinderExtraVolMounts) {
	*out = *in
	if in.CinderVolMounts != nil {
		in, out := &in.CinderVolMounts, &out.CinderVolMounts
...
func (in *CinderSpec) DeepCopyInto(out *CinderSpec) {
	*out = *in
	...
	if in.CinderVolumes != nil {
		...
		*out = make(map[string]CinderVolumeSpec, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CinderVolMounts) DeepCopyInto(out *CinderVolMounts) {
	*out = *in
	if in.Volumes != nil {
...
func (in *CinderVolMounts) DeepCopy() *CinderVolMounts {
	if in == nil {
		return nil
	}
	out := new(CinderVolMounts)
	in.DeepCopyInto(out)
	return out
}
