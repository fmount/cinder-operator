...
// +kubebuilder:rbac:groups="security.openshift.io",resourceNames=privileged;nonroot-v2,resources=securitycontextconstraints,verbs=use
	...
	rbacRules := []rbacv1.PolicyRule{
		{
			...
			ResourceNames: []string{"privileged", "nonroot-v2"},
